...
public class PayService {
    ...
    /**
     * @param onlinePay  在线支付金额
     * @param balancePay 余额支付金额
     * @param orderNo    订单号
     * @return
     * @throws Exception
     */
     ...
     */
    @Transactional
    public void updateOrderPayOk(PayCallbackResult result) throws Exception {
...
//			}
     ...
     */
    @Transactional
    public void updateOrderFreedomPayOk(PayCallbackResult result) throws Exception {
        logger.info("PayCallBack result :{}", result);
