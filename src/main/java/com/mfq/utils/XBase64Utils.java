...
public class XBase64Utils {
    ...
    static {
        byte[] __bytes;
        try {
            __bytes = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".getBytes(PREFERRED_ENCODING);
        } // end try
     ...
     *            Specified options
     * @return The Base64-encoded object
     * @see XBase64Utils#GZIP
     * @see XBase64Utils#DONT_BREAK_LINES
     * @since 2.0
     */
    ...
    public static byte[] decode(String s) {
        return decode(s, PREFERRED_ENCODING);
    } // end decode
    ...
    public static String encodeFromFile(String filename) {
        ...
        try {
            ...
            // Save in a variable to return
            encodedData = new String(buffer, 0, length, XBase64Utils.PREFERRED_ENCODING);
    ...
    public static class InputStream extends java.io.FilterInputStream {
         ...
         * @param options
         *            Specified options
         * @see XBase64Utils#ENCODE
         * @see XBase64Utils#DECODE
         * @see XBase64Utils#DONT_BREAK_LINES
         * @since 2.0
         */
        ...
        public void write(int theByte) throws java.io.IOException {
            ...
            // Else, Decoding
                ...
                if (DECODABET[theByte & 0x7f] > WHITE_SPACE_ENC) {
                    ...
                    {
                        int len = XBase64Utils.decode4to3(buffer, 0, b4, 0);
                        out.write(b4, 0, len);
